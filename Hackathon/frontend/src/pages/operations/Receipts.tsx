...
import { PackagePlus, Plus, Search, Filter } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white tracking-tight flex items-center gap-3">
              <PackagePlus className="text-primary-400" size={32} />
              Incoming Receipts
            </h1>
            <p className="text-slate-400 mt-2 font-light">Manage incoming stock from vendors.</p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <input 
              type="text" 
              placeholder="Search receipts by ID, vendor or reference..." 
        ...
        <div className="glass overflow-hidden rounded-2xl border border-white/10 shadow-2xl">
          <table className="w-full text-left border-collapse">
            <thead className="bg-white/5 border-b border-white/10">
              <tr>
                <th className="p-5 text-sm font-semibold text-slate-300 uppercase tracking-widest">Receipt ID</th>
                <th className="p-5 text-sm font-semibold text-slate-300 uppercase tracking-widest">Supplier</th>
            ...
            <tbody className="divide-y divide-white/5">
               {receipts.length === 0 ? (
                <tr><td colSpan={4} className="p-10 text-center text-slate-500 italic">No incoming receipts found.</td></tr>
               ) : null}
            </tbody>
          </table>
        </div>
